  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved product as @product" do
        ...
        post :create, {:product => { "price" => "invalid value" }}, valid_session
        assigns(:product).should be_a_new(Product)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested product" do
        ...
        Product.any_instance.should_receive(:update).with({ "price" => "9.99" })
        put :update, {:id => product.to_param, :product => { "price" => "9.99" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the product as @product" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Product.any_instance.stub(:save).and_return(false)
        put :update, {:id => product.to_param, :product => { "price" => "invalid value" }}, valid_session
        assigns(:product).should eq(product)
      end
